...
const STRINGS = {
  en: {
    ...
    cannotDiscardDeckEmpty: "Cannot discard — deck is empty, no replacement available",
  ...
  de: {
    ...
    cannotDiscardDeckEmpty: "Kann nicht abwerfen — Deck ist leer, keine Ersatzkarte verfügbar",
  ...
  tr: {
    ...
    cannotDiscardDeckEmpty: "Kart atılamaz — deste boş, yedek kart yok",
  ...
  ro: {
    ...
    cannotDiscardDeckEmpty: "Nu se poate arunca — pachetul e gol, nu există carte de înlocuire",
  ...
  es: {
    ...
    cannotDiscardDeckEmpty: "No se puede descartar — el mazo está vacío, no hay reemplazo",
  ...
  pl: {
    ...
    cannotDiscardDeckEmpty: "Nie można odrzucić — talia jest pusta, brak karty zastępczej",
